...
module Web
  class Application < Lotus::Application
    configure do
      ...
      #
      security.content_security_policy "default-src 'none' https://maxcdn.bootstrapcdn.com; script-src 'self' https://maxcdn.bootstrapcdn.com https://code.jquery.com; connect-src 'self'; img-src 'self' https://maxcdn.bootstrapcdn.com; style-src 'self' https://maxcdn.bootstrapcdn.com;"
